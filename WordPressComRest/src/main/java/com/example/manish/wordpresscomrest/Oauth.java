package com.example.manish.wordpresscomrest;
...
public class Oauth {
    ...
    public Request makeRequest(String username, String password, String twoStepCode, boolean shouldSendTwoStepSMS, Listener listener, ErrorListener errorListener) {
        return new PasswordRequest(getAppID(),
                getAppSecret(), getAppRedirectURI(),
                username, password, twoStepCode,
                shouldSendTwoStepSMS,
                listener,
                errorListener);
    }
