...
import com.example.manish.androidcms.widgets.SlidingTabLayout;
    ...
    implements MediaPickerFragment.OnMediaSelected
{
    ...
    /**
     * Shows {@link org.wordpress.mediapicker.MediaPickerFragment}'s in
     * a tabbed layout.
     */
    public class MediaPickerAdapter extends FragmentPagerAdapter
    {
        private class MediaPicker {
            ...
            public MediaPicker(String name,
                               String loading,
                               String error,
                               String empty,
        ...
        public void addTab(ArrayList<MediaSource> mediaSources,
                           String tabName, String loading,
                           String error, String empty) {
            mMediaPickers.add(new
                    MediaPicker(tabName, loading,
                    error, empty, mediaSources));
        }
    ...
    /**
     * Helper method;
     * sets up the tab bar, media adapter,
     * and ViewPager for displaying media content
     */
    ...
    /**
     * Helper method;
     * sets title to R.string.media_picker_title unless intent defines one
     */
    ...
    /**
     * Helper method; locks device orientation
     * to its current state while media is being selected
     */
    ...
    /**
     * Helper method; gathers
     * {@link org.wordpress.mediapicker.source.MediaSource}'s from intent
     */
    private void addMediaSources() {
        ...
        if(intent!= null)
        {
            ...
            List<MediaSource> mediaSources =
                    intent.getParcelableArrayListExtra(DEVICE_IMAGE_MEDIA_SOURCES_KEY);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if(item.getItemId() == android.R.id.home)
        {
            ...
            WordPressMediaUtils.launchCamera(this,
    ...
    public boolean onMenuItemSelected(MenuItem menuItem,
                                      ArrayList<MediaItem> selectedContent) {
