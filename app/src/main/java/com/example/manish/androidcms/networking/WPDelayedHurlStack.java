...
/**
 * An {@link com.android.volley.toolbox.HttpStack} based on the code of {@link com.android.volley.toolbox.HurlStack} that internally
 * uses a {@link java.net.HttpURLConnection}.
 *
 * This implementation of {@link com.android.volley.toolbox.HttpStack} internally initializes {@link SelfSignedSSLCertsManager} in a secondary
...
public class WPDelayedHurlStack implements HttpStack {
    ...
    public HttpResponse performRequest(Request<?> request,
        ...
        if (request.getUrl() != null) {
            ...
            if (StringUtils.getHost(request.getUrl()).endsWith("files.wordpress.com") && mCtx != null
                    && CMS.getWPComAuthToken(mCtx) != null) {
                // Add the auth header to access private WP.com files
                additionalHeaders.put("Authorization", "Bearer " + CMS.getWPComAuthToken(mCtx));
            }
        }

        additionalHeaders.put("User-Agent", CMS.getUserAgent());
    ...
    private HttpURLConnection openConnection(URL url, Request<?> request) throws IOException {
        ...
        //Bug in android.colley to be resolved by this piece of code
