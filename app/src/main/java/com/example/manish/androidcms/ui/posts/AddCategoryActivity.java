...
public class AddCategoryActivity extends ActionBarActivity {
            ...
            public void onClick(View v) {
                ...
                if (sCategories.getSelectedItem() != null)
                    parent_category = ((CategoryNode)
                            sCategories.getSelectedItem()).getName().trim();
                int parent_id = 0;
                if (sCategories.getSelectedItemPosition() != 0) {
                    parent_id = CMS.cmsDB.getCategoryId(id, parent_category);
                }
                ...
                if (category_name.replaceAll(" ", "").equals("")) {
                    ...
                    AlertDialog.Builder dialogBuilder = new AlertDialog
                            .Builder(AddCategoryActivity.this);
    ...
    private void loadCategories() {
        ...
        ArrayList<CategoryNode> categoryLevels =
                CategoryNode.getSortedListOfCategoriesFromRoot(rootCategory);
        categoryLevels.add(0, new CategoryNode(0, 0, getString(R.string.none)));
        if (categoryLevels.size() > 0) {
            ParentCategorySpinnerAdapter categoryAdapter = new ParentCategorySpinnerAdapter(
                    this,
