        ...
        implements View.OnClickListener, TextView.OnEditorActionListener
{
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        ViewGroup rootView = (ViewGroup) inflater
                .inflate(R.layout.fragment_edit_post_settings,
                        container,
                        false);
        ...
        if(pubDate !=0)
        {
            try
            {
                ...
                String formattedDate =
                        DateUtils.formatDateTime(getActivity(), pubDate,
                                flags);
        ...
        mSectionCategories = (ViewGroup)rootView.findViewById(R.id.sectionCategories);
                ...
                ((TextView) rootView.findViewById(R.id.categoryLabel)).setText("Categories".toUpperCase());
        ((TextView)rootView.findViewById(R.id.statusLabel)).setText("Status".toUpperCase());
        ((TextView)rootView.findViewById(R.id.postFormatLabel)).setText("Post format".toUpperCase());
        ((TextView)rootView.findViewById(R.id.pubDateLabel)).setText("Publish".toUpperCase());
    ...
    private void initLocation(ViewGroup rootView) {
        ...
        Post post = mActivity.getPost();
        // show the location views if a provider was found
        // and this is a post on a blog that has location enabled
        if (hasLocationProvider()
            && post.supportsLocation())
        {
            View locationRootView = ((ViewStub) rootView.findViewById(R.id.stub_post_location_settings)).inflate();

           // View inflated = locationRootView
    ...
    */
    ...
    private boolean hasLocationProvider() {
        ...
        LocationManager locationManager = (LocationManager)
                getActivity().getSystemService(Activity.LOCATION_SERVICE);
    ...
    private void populateSelectedCategories() {
        ...
        for (int i = 0; i < mSectionCategories.getChildCount(); i++) {
            ...
            if (tag != null && tag.getClass() == String.class &&
                    (((String) tag).startsWith(CATEGORY_PREFIX_TAG)
                            || tag.equals("select-category"))) {
                viewsToRemove.add(v);
            }
        }
        ...
        for (String categoryName : mCategories) {
            Button buttonCategory = (Button) layoutInflater.
                    inflate(R.layout.category_button, null);
        ...
        Button selectCategory = (Button)layoutInflater.inflate(R.layout.category_select_button,
                null);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data)
    {
        ...
        if(data != null || ((requestCode ==
                WordPressMediaUtils.RequestCode.ACTIVITY_REQUEST_CODE_TAKE_PHOTO ||
    ...
    public void onClick(View v) {
        ...
        else if(id == R.id.selectCategories)
        {
            ...
            bundle.putInt("id", CMS.getCurrentBlog().getLocalTableBlogId());
    ...
    private class GetCoordsTask extends android.os.AsyncTask<String, Void, Address> {
        @Override
        protected void onPreExecute() {
            setLocationStatus(LocationStatus.SEARCHING);
            showLocationView();
    ...
    */
    private void fetchCurrentLocation() {
        ...
        boolean canGetLocation = mLocationHelper
                .getLocation(getActivity(), locationResult);
        ...
        new AlertDialog.Builder(getActivity())
                ...
                .setPositiveButton(android.R.string.ok,
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Date d = new Date(mYear - 1900,
                                mMonth, mDay, mHour, mMinute);
                        ...
                        try {
                            ...
                            String formattedDate =
                                    DateUtils.formatDateTime(getActivity(), timestamp, flags);
    ...
    public void updatePostSettings() {
        ...
        String pubDate = (mPubDateText.getText() != null) ?
                mPubDateText.getText().toString() : "";
        ...
        /*String excerpt = (mExcerptEditText.getText() != null) ?
                mExcerptEditText.getText().toString() : "";

        String tags = "", postFormat = "";
        if (!post.isPage()) {
            tags = (mTagsEditText.getText() != null) ?
                    mTagsEditText.getText().toString() : "";

            // post format
            if (mPostFormats != null &&
        ...
        String password = (mPasswordEditText.getText() != null) ?
        ...
        */
        ...
        String status =
                getPostStatusForSpinnerPosition(mStatusSpinner.getSelectedItemPosition());
