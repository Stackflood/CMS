...
public class CMSAlertDialogFragment extends DialogFragment implements DialogInterface.OnClickListener {
    ...
    public static CMSAlertDialogFragment newAlertDialog(String message) {
        String title = CMS.getContext().getString(R.string.error_generic);
        return newAlertDialog(title, message);
    }
    public static CMSAlertDialogFragment newAlertDialog(String title, String message) {
        return newInstance(title, message, WPAlertDialogType.ALERT, null, null);
    }

    public static CMSAlertDialogFragment newConfirmDialog(String title,
                                                         String message) {
        return newInstance(title, message, WPAlertDialogType.CONFIRM, null, null);
    }

    public static CMSAlertDialogFragment newUrlInfoDialog(String title,
                                                         String message,
                                                         String infoTitle,
                                                         String infoUrl) {
    ...
    private static CMSAlertDialogFragment newInstance(String title,
                                                     String message,
                                                     WPAlertDialogType alertType,
                                                     String infoTitle,
                                                     String infoUrl) {
        CMSAlertDialogFragment dialog = new CMSAlertDialogFragment();
