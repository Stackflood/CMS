...
//import com.example.manish.androidcms.GenericCallback;
...
public class SelfSignedSSLCertsManager {
    ...
    public boolean isCertificateTrusted(X509Certificate x509Certificate){
        ...
        try {
            ...
            AppLog.e(AppLog.T.API, "Cannot check if the certificate is in KeyStore. Seems that Keystore is not initialized.", e);
        }
