...
public class RestClientUtils {
     ...
     */
    public void replyToComment(String reply, String path, RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     */
    public void followSite(String siteId, RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     */
    public void unfollowSite(String siteId, RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     */
    public void getNotifications(Map<String, String> params, RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     * https://developer.wordpress.com/docs/api/1/get/notifications/
     */
    public void getNotifications(RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     */
    public void markNotificationsSeen(String timestamp, RestRequest.Listener listener, ErrorListener errorListener) {
        Map<String, String> params = new HashMap<String, String>();
     ...
     */
    public void getThemes(String siteId, int limit, int offset, RestRequest.Listener listener, ErrorListener errorListener) {
     ...
     * Set a site's theme
     */
    public void setTheme(String siteId, String themeId, RestRequest.Listener listener, ErrorListener errorListener) {
        Map<String, String> params = new HashMap<String, String>();
     ...
     */
    public void getCurrentTheme(String siteId, RestRequest.Listener listener, ErrorListener errorListener) {
        String path = String.format("sites/%s/themes/mine", siteId);
        get(path, listener, errorListener);
    }
     ...
     * Make GET request
     */
    public Request<JSONObject> get(String path, RestRequest.Listener listener, ErrorListener errorListener)  {
     ...
     * Make POST request
     */
    public void post(String path, RestRequest.Listener listener, ErrorListener errorListener) {
